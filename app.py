...
from gridfs import GridFS # *** 關鍵修改：修正大小寫錯誤 ***
...
# --- 背景任務 ---
def compression_worker(task_id_str, recipient_email=None):
    ...
    try:
        ...
        tasks_collection.update_one({'_id': task_id}, {'$set': { 
            ...
            'result_file_id': str(file_id), 'result_filename': final_filename, 
